...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/graduation/manage/admin_index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">用户管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/graduation/manage/admin_douserselect" method="get">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">姓名:</th>
                            <td><input class="common-text" placeholder="姓名/关键字" name="keywords" value="${param.keywords}" id="" type="text"></td>
	                        ...
	                        <tr>
	                            ...
	                            <td> ${u.USER_ID  }</td>
	                             <td> ${u.USER_NAME  }</td>
	                              <td> ${u.SEX=='T'?'男':'女' }</td>
	                               <td> ${u.EMAIL  }</td>
	                                <td> 
	                                    ${u.STATUS=='1'?'管理员':u.STATUS=='0'?'读者':'作者' }
	                                </td>
	                            ...
	                            <td>
	                              ...
	                              <c:if test="${u.STATUS!=1}">
	                                <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.USER_NAME}】吗？', '/graduation/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage }')">删除</a>
	                              </c:if>
