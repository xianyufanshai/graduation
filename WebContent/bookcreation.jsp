	...
	<body>
        ...
        <div class="m-padded-tb-large">
            ...
            <div class="ui attached segment " style="background: url(images/m3.jpg);">
            	<form action="creationadd" method="post"  enctype="multipart/form-data"   id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="writerName" size="50" value="${user.USER_NAME }" type="text" readonly="">
                                </td>
                            </tr>
